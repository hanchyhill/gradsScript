...
'enable print F:\reanalysis\img\filter_2\H_olr.filter.3.(8t_17t)_-15-30.gmf'
*whilte to blue
...
'run cbar'
'draw title olr filter(8d_17d,107.5-112.5E) 0- 30N'
'print' 
'c'
'set clevs -60 -50 -40 -30 -20 -10 0 10 20 30 40 50'
'set ccols 32 31 30 29 28 27 26 38 37 36 35 34 33'
...
'd olr'
'run cbar'
'draw title olr filter(8d_17d) 110E-10S 30N'
'print' 
'c'
'set clevs -60 -50 -40 -30 -20 -10 0 10 20 30 40 50'
'set ccols 32 31 30 29 28 27 26 38 37 36 35 34 33'
...
'd ave(olr,lat=10,lat=17.5)'
'run cbar'
'draw title olr filter(8d_17d,10N-17.5N.ave)-80E 140E'
'print' 
'c'
'set clevs -60 -50 -40 -30 -20 -10 0 10 20 30 40 50'
'set ccols 32 31 30 29 28 27 26 38 37 36 35 34 33'
