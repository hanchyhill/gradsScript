...
'set arrowhead 0.1'
'set cthick 6'
'define aveu=ave(uwnd.3,t=244,t=289)'
'define avev=ave(vwnd.4,t=244,t=289)'
'd skip(aveu,2,1);skip(avev,2,1)'
...
'gxprint F:\reanalysis\img\new_new\ave.sst.wind_track_09_10.V5.pdf white'
;
